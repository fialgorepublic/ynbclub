...
ActiveRecord::Schema.define(version: 2020_02_26_065737) do
  ...
  create_table "conversation_likes", force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "conversation_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["conversation_id"], name: "index_conversation_likes_on_conversation_id"
    t.index ["user_id"], name: "index_conversation_likes_on_user_id"
  end
